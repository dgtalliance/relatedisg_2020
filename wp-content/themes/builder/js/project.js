							...
							if (is_in_view($(this))){
								...
								if ($urlVideo !== undefined) {
									...
									if ($urlVideo.indexOf('youtube') !== -1) {
										...
										var srcVideo = 'https://www.youtube.com/embed/' + $urlVideo.substring($urlVideo.length - 11, $urlVideo.length) + '?autoplay=1;rel=0&showinfo=0&mute=1';
										...
										$(this).html('<iframe allow="autoplay; encrypted-media" src="' + srcVideo + '?autoplay=1&</wbr>muted=1" frameborder="0" allowfullscreen></iframe>');
									} else {
