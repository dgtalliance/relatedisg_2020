              ...
              <div class="options-list">
                <div class="shared-content">
                  ...
                  <ul class="shared-list">
                    <li><a data-share-url="<?php echo $building_permalink; ?>" data-share-title="<?php echo $post->post_title; ?>" data-share-description="<?php echo $post->post_title . ' - ' . $building_default_address; ?>" data-share-image="<?php echo str_replace("https://idxboost.com", "https://www.idxboost.com", $response['payload']['gallery_building'][0]["url_image"]); ?>" class="ico-facebook property-detail-share-fb" onclick="idxsharefb()" title="Faceboook" rel="nofollow"><?php echo __("Faceboook", IDXBOOST_DOMAIN_THEME_LANG); ?></a></li>
