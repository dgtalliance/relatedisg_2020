...
$filter_type = '0';
if (array_key_exists('filter_type', $response)) $filter_type = $response['filter_type'];
      ...
      <div class="gwr gwr-filters">
        ...
        <?php if ($filter_type != '4') { ?>
          <ul id="filters">
            ...
            $property_types_label = array_map(function ($item) {
              return $item['label'];
            }, $search_params['property_types']);
            ?>
            <li class="type">
                  ...
                  <div class="wrap-checks">
                    <ul>
                      ...
                      foreach ($search_params['amenities'] as $amenity) :
                        if ((5 != $board_id) && ("loft" == $amenity["code"])) {
                          continue;
                        }
                        if ((5 == $board_id) && ("water_front" == $amenity["code"])) {
                          continue;
                        }
                        if ((!in_array($board_id, [1, 2, 3])) && ("hopa" == $amenity["code"])) {
                          continue;
                        }
                      ?>
                        <li>
                          <input class="amenities_checkbox" type="checkbox" <?php if (in_array($amenity['code'], $features_info)) {
                                                                              echo 'checked';
