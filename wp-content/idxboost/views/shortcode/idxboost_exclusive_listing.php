...
?>
<script>
  <?php /*var filter_metadata = <?php //echo trim(json_encode($response)); ?>*/ ?>
...
$viewfilter = '';
if (empty($response['view']))  $viewfilter = 'grid';
else $viewfilter = $response['view'];
            ...
            <?php foreach ($response['items'] as $key_property => $property) : ?>
              ...
              <li data-address="<?php echo $property['address_short']; ?>" data-mls="<?php echo $property['mls_num']; ?>" class="propertie" data-geocode="<?php echo $property['lat']; ?>:<?php echo $property['lng']; ?>" data-class-id="<?php echo $property['class_id']; ?>">
                ...
                <?php if (isset($property["status"])) : ?>
                  <?php if ('yes' != $is_recent_sales) : ?>
                    <?php if (isset($agent_registration_key) && !empty($agent_registration_key)) : ?>
                      <a class="view-detail" href="<?php echo rtrim(get_permalink(get_the_ID()), "/"); ?>/property/<?php echo $property['slug']; ?>"><?php echo $property['full_address']; ?></a>
                    <?php else : ?>
                      <a class="view-detail" href="<?php echo $url_property; ?>"><?php echo $property['full_address']; ?></a>
                    <?php endif; ?>
                  <?php else : ?>
                    <?php if (isset($agent_registration_key) && !empty($agent_registration_key)) : ?>
                      <a class="view-detail is-sold-listings" href="<?php echo rtrim(get_permalink(get_the_ID()), "/"); ?>/property/<?php echo $property['slug']; ?>"><?php echo $property['full_address']; ?></a>
                    <?php else : ?>
                      <a class="view-detail is-sold-listings" href="<?php echo $url_property; ?>"><?php echo $property['full_address']; ?></a>
                    <?php endif; ?>
                  <?php endif; ?>
                <?php endif; ?>
                <?php /*
                ...
                if (array_key_exists("hackbox", $response)) {
                  if ($response["hackbox"]['status'] != false) {
                    if (!empty($response["hackbox"]['result']['content'])) { ?>
                      <li class="propertie button_properties">
                        <div class="ppc-content ppc-video-box"><?php echo $response["hackbox"]['result']['content']; ?></div>
                      </li>
              <?php }
                  }
                }
