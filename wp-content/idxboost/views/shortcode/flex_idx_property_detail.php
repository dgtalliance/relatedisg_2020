...
if (!empty($agent_registration_key)) {
...
<?php else : ?>
  ...
  <?php if (true === $registration_is_forced) : ?>
    <script type="text/javascript">
      (function($) {
        $(function() {
          // disable force registration if agent didnt set
      ...
      <div class="content-fixed">
        <div class="content-fixed-title">
          ...
          <div class="breadcrumb-options">
            ...
            <?php if (!empty($agent_registration_key)) :
          ...
          <div class="form-content">
            <div class="avatar-content">
              ...
              <div class="content-avatar-image">
                <?php if (!empty($rel_agent_photo_src)) : ?>
              ...
              <div class="avatar-information">
                <?php if (!empty($rel_agent_full_name)) : ?>
                  <h2><?php echo $rel_agent_full_name; ?></h2>
                <?php else : ?>
                  <h2><?php echo $agent_info_name; ?></h2>
                <?php endif; ?>
                <?php if (!empty($rel_agent_phone_number)) : ?>
