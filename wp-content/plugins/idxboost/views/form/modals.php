          ...
          <div id="tabLogin" class="item_tab active">
            ...
            <div class="form_content">
              <form id="formLogin" method="post">
                ...
                ?>
                  <input type="hidden" name="registration_key" value="<?php echo get_post_meta($post->ID, "_flex_agent_registration_key", true); ?>">
                <?php
                }
                ?>
      ...
      $(function() {
        ...
        $(".ms-skip").on("click", function() {
          ...
          if ($(this).hasClass('ms-close-step')) {
            ...
            $("#ib-push-registration-quizz-ct .facebook-registration").removeClass('ib-active').css({
              'display': 'none'
            });
          ...
          FB.api('/me?fields=name,first_name,last_name,email,picture.width(100).height(100)', function(response) {
            ...
            jQuery.ajax({
              ...
              data: {
                ...
                registration_key: ("undefined" !== typeof IB_AGENT_REGISTRATION_KEY) ? IB_AGENT_REGISTRATION_KEY : null
              },
              dataType: "json",
              success: function(response) {
                var ib_log_message = response.message;
