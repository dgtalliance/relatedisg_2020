...
<div class="ms-profile-menu">
  <div class="ms-header-profile">
    ...
    <div class="ms-wrap-name">
      ...
      <span class="ms-sub-title"><a href="<?php echo $flex_idx_info["pages"]["flex_idx_profile"]["guid"]; ?>">Profile</a></span>
    </div>
    <button class="ms-btn-back">
      <span></span>
    </button>
  </div>
    ...
    <div class="ms-wrap-detail">
      ...
      <div class="ms-info-agent">
        <h3 class="ms-title ib-lead-firstname">&nbsp;</h3>
          <p><?php echo __("Call or email if you need immediate 
        assistance. Thanks!", IDXBOOST_DOMAIN_THEME_LANG); ?></p>
        <h4 class="ms-sub-title ib-agent-fullname">&nbsp;</h4>
        <div class="ms-wrap-action">
          <a href="#" class="ms-phone ib-agent-phonenumber">&nbsp;</a>
          <a href="#" class="ms-email ib-agent-emailaddress">Email</a>
        </div>
      </div>
    </div>
            ...
            success: function(response) {
              ...
              if (response.lead_info.saved_listings.length) {
                ...
                for (var i = 0, l = lead_listing_views.length; i < l; i++) {
                  ...
                  lead_listing_views_html.push('</div>');
                  lead_listing_views_html.push('<div class="ms-property-actions">'); 
                  lead_listing_views_html.push('<button data-mls="'+lead_listing_views[i].mls_num+'" data-token-alert="'+lead_listing_views[i].token_alert+'" class="ib-la-rf ms-delete active"><span>save</span></button>');
                  // lead_listing_views_html.push('<button class="ms-delete"><span>Delete</span></button>');
                  lead_listing_views_html.push('</div>');
                  lead_listing_views_html.push('<a href="'+__flex_g_settings.propertyDetailPermalink+'/'+lead_listing_views[i].slug+'" target="_blank" class="ms-link">'+lead_listing_views[i].address_short + ' ' +  lead_listing_views[i].address_large +'</a>');
                  lead_listing_views_html.push('</div>');
            ...
            success: function(response) {
              ...
              if (response.lead_info.saved_searches.length) {
                ...
                for (var i = 0, l = lead_listing_views.length; i < l; i++) {
                  ...
                  lead_listing_views_html.push('<div class="ms-wrap-img">');
                  lead_listing_views_html.push('<span class="ms-count">'+formatShortPriceX(lead_listing_views[i].search_count)+'</span> <span class="ms-listing">LISTINGS</span>');
                  lead_listing_views_html.push('</div>');
                  lead_listing_views_html.push('<div class="ms-property-detail">');
                  lead_listing_views_html.push('<h3 class="ms-title">'+lead_listing_views[i].name+'</h3>');
                  lead_listing_views_html.push('<h4 class="ms-date">Saved on '+lead_listing_views[i].f_date+'</h4>');
                  lead_listing_views_html.push('</div>');
                  lead_listing_views_html.push('<div class="ms-property-actions">');
                  lead_listing_views_html.push('<button data-id="'+lead_listing_views[i].id+'" data-token-alert="'+lead_listing_views[i].token_alert+'" class="ib-la-rss ms-delete"><span>Delete</span></button>');
                  lead_listing_views_html.push('</div>');
            ...
            success: function(response) {
              ...
              if (response.lead_info.saved_listings.length) {
                ...
                for (var i = 0, l = lead_listing_views.length; i < l; i++) {
                  ...
                  lead_listing_views_html.push('</div>');
                  lead_listing_views_html.push('<div class="ms-property-actions">');
                  lead_listing_views_html.push('<button data-mls="'+lead_listing_views[i].mls_num+'" data-token-alert="'+lead_listing_views[i].token_alert+'" class="ib-la-rf ms-save"><span>save</span></button>');
                  // lead_listing_views_html.push('<button class="ms-delete"><span>Delete</span></button>');
                  lead_listing_views_html.push('</div>');
                  lead_listing_views_html.push('<a href="'+__flex_g_settings.propertyDetailPermalink+'/'+lead_listing_views[i].slug+'" target="_blank" class="ms-link">'+lead_listing_views[i].address_short + ' ' +  lead_listing_views[i].address_large +'</a>');
                  lead_listing_views_html.push('</div>');
