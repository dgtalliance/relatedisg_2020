        ...
        <div class="content-fixed-title">
          ...
          <div class="breadcrumb-options">
            <?php if (wp_get_referer()) : ?>
              <a href="<?php echo wp_get_referer(); ?>" class="btn link-back clidxboost-icon-arrow-select" <?php echo __("Back to results", IDXBOOST_DOMAIN_THEME_LANG); ?></a> <?php endif ?> <a href="#flex-idx-property-form" class="btn-request"><?php echo __("Request information", IDXBOOST_DOMAIN_THEME_LANG); ?></a>
        ...
        <div class="container">
          <ul class="property-information" data-inf="price:<?php echo isset($property['is_sold']) ? $property['price_sold'] : $property['price']; ?>|beds:<?php echo $property['bed']; ?>|baths:<?php echo $property['bath']; ?>|sqft:<?php echo $property['sqft']; ?>">
            ...
            <li><?php echo $property['bed']; ?> <span><?php if ($property['bed'] > 1) {
                                                        echo __("Bedrooms", IDXBOOST_DOMAIN_THEME_LANG);
                                                      } else {
                                                        echo __("Bedroom", IDXBOOST_DOMAIN_THEME_LANG);
                                                      } ?> </span></li>
            <li><?php echo $property['bath']; ?> <span><?php if ($property['bath'] > 1) {
                                                          echo __("Bathrooms", IDXBOOST_DOMAIN_THEME_LANG);
                                                        } else {
                                                          echo __("Bathroom", IDXBOOST_DOMAIN_THEME_LANG);
                                                        } ?> </span></li>
...
<script type="text/javascript">
  ...
  if (!empty($CollapsedPreference)) {
    if ($CollapsedPreference == '1') { ?>
      ...
      <?php } ?>
      <?php if (is_numeric(array_search('school_information', $CollapsedPreferenceDetailt)) != false) { ?> jQuery('.clidxboost-schools-container').addClass('active');
      <?php } ?>
    <?php  } else { ?>
