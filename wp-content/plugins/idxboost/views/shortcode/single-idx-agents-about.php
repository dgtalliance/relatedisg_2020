  ...
  <main id="flex-about-theme">
    ...
    <div class="gwr c-flex intro-about">
      <article class="flex-block-description">
        ...
        <?php if (!empty($agent_full_info) && (isset($agent_full_info['info']) && isset($agent_full_info['info']['bio'])) ): ?>
        <?php echo $agent_full_info['info']['bio']; ?>
        <?php endif; ?>
      </article>
      <?php if(!empty($agent_full_info) && !empty($agent_full_info['info']['agent_photo_file'])): ?>
      <img src="<?php echo $agent_full_info['info']['agent_photo_file']; ?>" <?php if ( !empty($agent_full_info['info']['first_name']) && !empty($agent_full_info['info']['last_name']) && !empty($agent_full_info['info']['agent_title'])): ?> alt="<?php echo $agent_full_info['info']['first_name']; ?> <?php echo $agent_full_info['info']['last_name']; ?> - <?php echo 
      $agent_full_info['info']['agent_title']; ?>"<?php endif; ?>>
      <?php endif; ?>
    </div>
  </main>
