...
//delete feature hopa
if (
  [1, 2, 3].includes(parseFloat(__flex_idx_search_filter.boardId)) === false
) {
  var item_dele = __flex_idx_search_filter.search.amenities
    .map(function (item) {
      return item.code;
    })
    .indexOf("hopa");
...
(function ($) {
  ...
  Handlebars.registerHelper("capturePositionHackbox", function (index) {
    ...
    if (typeof __flex_idx_search_filter.list_offmarket.status !== "undefined") {
      ...
      html_market.push(
        '<li class="ib-pitem"><div class="ib-pislider gs-container-slider gs-loaded" id="collection-markert">'
      );
      __flex_idx_search_filter.list_offmarket.data.forEach(function (item) {
        html_market.push(
          '<div class="ib-item"><img class="ib-pifimg" src="' +
            item.image +
            '" alt="' +
            item.address +
            '"><h3 class="ib-title">' +
            item.address +
            '</h3><div class="ib-wrap-btn"><a target="_blank" href="" class="ib-mr-link idx_view_collection_market"><span>View Collection</span></a> <a target="_blank" href="https://management.urbanresource.com/page-property/' +
            item.property_id +
            '" class="ib-mr-link idx_view_detail_market"><span>' +
            word_translate.details +
            "</span></a></div></div>"
        );
      });
      html_market.push(
        '<div class="gs-navs-off-market"><div class="gs-om-arrows"><button class="gs-om-prev-arrow btn_prev_item" method="prev"></button><button class="gs-om-next-arrow btn_next_item" method="next"></button></div></div><span class="ib-label">Managed by Urban Resource</span></div></li>'
      );
    }
    ...
    if (1 == IB_SEARCH_FILTER.attr("data-count")) {
      if (html_market.length > 0) {
        ...
        if (__flex_idx_search_filter.hackbox.content.length) {
          return (
            '<li class="ib-pitem ib-pitem-marketing">' +
            __flex_idx_search_filter.hackbox.content +
            "</li>"
          );
        } else {
          return "";
  ...
  Handlebars.registerHelper("handleStatusProperty", function (property) {
    if ("yes" === property.recently_listed) {
      return (
        '<li class="ib-piitem ib-pstatus">' +
        word_translate.new_listing +
        "!</li>"
      );
    } else if (1 != property.status) {
      return (
        '<li class="ib-piitem ib-pstatus">' + word_translate.pending + "</li>"
      );
    }
  });
  ...
  Handlebars.registerHelper("rentalType", function (rentalType) {
    return "1" == rentalType
      ? word_translate.similar_properties_for_rent
      : word_translate.Similar_properties_for_sale;
  });
  ...
  Handlebars.registerHelper("idxPermalink", function (property) {
    return (
      __flex_idx_search_filter.propertyDetailPermalink + "/" + property.slug
    );
  });
  ...
  Handlebars.registerHelper("idxFavoriteText", function (property) {
    return "" === property.token_alert
      ? word_translate.save_favorite
      : word_translate.remove_favorite;
  });
  ...
  __flex_idx_search_filter.search.price_sale_range.push({
    label: word_translate.any_price,
    value: "--",
  });
  __flex_idx_search_filter.search.price_rent_range.push({
    label: word_translate.any_price,
    value: "--",
  });

  __flex_idx_search_filter.search.living_size_range.push({
    label: word_translate.any_size,
    value: "--",
  });
  __flex_idx_search_filter.search.lot_size_range.push({
    label: word_translate.any_size,
    value: "--",
  });
  ...
  function ib_fetch_default_cities() {
    var ib_autocomplete_cities = _.pluck(
      __flex_g_settings.params.cities,
      "name"
    );
    var featured_cities = [];
  ...
  var IB_RG_PRICE_SALE_VALUES = _.pluck(
    __flex_idx_search_filter.search.price_sale_range,
    "value"
  );
  var IB_RG_PRICE_RENT_VALUES = _.pluck(
    __flex_idx_search_filter.search.price_rent_range,
    "value"
  );
  var IB_RG_BEDROOMS_VALUES = _.pluck(
    __flex_idx_search_filter.search.beds_range,
    "value"
  );
  var IB_RG_BATHROOMS_VALUES = [0, 1, 2, 3, 4, 5, 6];
  var IB_RG_LIVINGSIZE_VALUES = _.pluck(
    __flex_idx_search_filter.search.living_size_range,
    "value"
  );
  var IB_RG_LANDSIZE_VALUES = _.pluck(
    __flex_idx_search_filter.search.lot_size_range,
    "value"
  );
  var IB_RG_YEARBUILT_VALUES = _.pluck(
    __flex_idx_search_filter.search.year_built_range,
    "value"
  );
  ...
  function setupMapControls() {
    ...
    IB_MAP.controls[google.maps.ControlPosition.TOP_RIGHT].push(
      mapButtonsWrapper
    );
  }
    ...
    return function () {
      ...
      if (property.group.length > 1) {
        ...
        if (null != property.item.complex && "" !== property.item.complex) {
          infobox_content.push(
            '<h3 class="ib-ibtitle"><span class="ib-ibtxt">' +
              property.item.complex +
              "</span></h3>"
          );
        } else {
        ...
        infobox_content.push(
          '<div class="ib-ibclose"><span>Close</span></div>'
        );
        ...
        for (var i = 0, l = property.group.length; i < l; i++) {
          ...
          infobox_content.push(
            '<li class="ib-ibpitem" data-mls="' + property_group.mls_num + '">'
          );
          infobox_content.push('<div class="ib-ibpa">');
          infobox_content.push(
            '<h4 class="ib-ibptitle">' + property_group.address_short + "</h4>"
          );
          infobox_content.push('<ul class="ib-ibdetails">');
          infobox_content.push(
            '<li class="ib-ibditem ib-ibaddress">' +
              property_group.address_large +
              "</li>"
          );

          if (1 == property_group.is_rental) {
            infobox_content.push(
              '<li class="ib-ibditem ib-ibprice">$' +
                _.formatPrice(property_group.price) +
                "/" +
                word_translate.month +
                "</li>"
            );
          } else {
            infobox_content.push(
          ...
          infobox_content.push(
            '<li class="ib-ibditem ib-ibbeds"><span class="ib-ibdbold">' +
              property_group.bed +
              "</span>" +
              word_translate.beds +
              "</li>"
          ...
          if (property_group.baths_half > 0) {
            infobox_content.push(
              '<li class="ib-ibditem ib-ibbaths"><span class="ib-ibdbold">' +
                property_group.bath +
                (property_group.baths_half > 0 ? ".5" : "") +
                "</span>" +
                word_translate.baths +
                "</li>"
            );
          } else {
            infobox_content.push(
          ...
          infobox_content.push(
            '<li class="ib-ibditem ib-ibsqft"><span class="ib-ibdbold">' +
              _.formatPrice(property_group.sqft) +
              "</span>" +
              word_translate.sqft +
              "</li>"
          );
          ...
          if (property_group.sqft > 0) {
            infobox_content.push(
              '<li class="ib-ibditem ib-ibsqft"><span class="ib-ibdbold">$' +
                _.formatPrice(property_group.price / property_group.sqft) +
                "</span>/ " +
                word_translate.sqft +
                "</li>"
            );
          ...
          infobox_content.push(
            '<a href="' +
              __flex_idx_search_filter.propertyDetailPermalink +
              "/" +
              property_group.slug +
              '"></a></li>'
          );
        ...
        infobox_content.push('<ul class="ib-ibproperties">');
        infobox_content.push(
          '<li class="ib-ibpitem" data-mls="' + property.item.mls_num + '">'
        );
        infobox_content.push('<div class="ib-ibpa">');
        infobox_content.push(
          '<h4 class="ib-ibptitle">' + property.item.address_short + "</h4>"
        );
        infobox_content.push('<ul class="ib-ibdetails">');
        infobox_content.push(
          '<li class="ib-ibditem ib-ibaddress">' +
            property.item.address_large +
            "</li>"
        );
        ...
        if (1 == property.item.is_rental) {
          infobox_content.push(
            '<li class="ib-ibditem ib-ibprice">$' +
              _.formatPrice(property.item.price) +
              "/" +
              word_translate.month +
              "</li>"
          );
        ...
        infobox_content.push(
          '<li class="ib-ibditem ib-ibsqft"><span class="ib-ibdbold">' +
            _.formatPrice(property.item.sqft) +
            "</span>" +
            word_translate.sqft +
            "</li>"
        );
        ...
        if (property.item.sqft > 0) {
          infobox_content.push(
            '<li class="ib-ibditem ib-ibsqft"><span class="ib-ibdbold">$' +
              _.formatPrice(property.item.price / property.item.sqft) +
              "</span>/ " +
              word_translate.sqft +
              "</li>"
          );
      ...
      if (infobox_content.length) {
        if (window.innerWidth < 990) {
          ...
          if ($botonera.length && $botonera.is(":visible")) {
            tBottom +=
              $botonera.height() +
              Number($botonera.css("bottom").replace("px", "")) +
              5;
          } else {
            const $ctas = $(".cta-container");
            if ($ctas.length && $ctas.is(":visible"))
              tBottom +=
                $ctas.height() +
                Number($ctas.css("bottom").replace("px", "")) +
                5;
          }
  ...
  function getPriceSaleValues(min, max) {
    var r_min =
      null == min || "--" == min
        ? 0
        : IB_RG_PRICE_SALE_VALUES.indexOf(parseInt(min, 10));
    var r_max =
      null == max || "--" == max
        ? IB_RG_PRICE_SALE_VALUES.length - 1
        : IB_RG_PRICE_SALE_VALUES.indexOf(parseInt(max, 10));
  ...
  function getPriceRentValues(min, max) {
    var r_min =
      null == min || "--" == min
        ? 0
        : IB_RG_PRICE_RENT_VALUES.indexOf(parseInt(min, 10));
    var r_max =
      null == max || "--" == max
        ? IB_RG_PRICE_RENT_VALUES.length - 1
        : IB_RG_PRICE_RENT_VALUES.indexOf(parseInt(max, 10));
  ...
  function getYearValues(min, max) {
    var r_min =
      null == min ? 0 : IB_RG_YEARBUILT_VALUES.indexOf(parseInt(min, 10));
    var r_max =
      null == max
        ? IB_RG_YEARBUILT_VALUES.length - 1
        : IB_RG_YEARBUILT_VALUES.indexOf(parseInt(max, 10));
  ...
  function getBedroomValues(min, max) {
    var r_min =
      null == min ? 0 : IB_RG_BEDROOMS_VALUES.indexOf(parseInt(min, 10));
    var r_max =
      null == max
        ? IB_RG_BEDROOMS_VALUES.length - 1
        : IB_RG_BEDROOMS_VALUES.indexOf(parseInt(max, 10));
  ...
  function getBathroomValues(min, max) {
    var r_min =
      null == min ? 0 : IB_RG_BATHROOMS_VALUES.indexOf(parseInt(min, 10));
    var r_max =
      null == max
        ? IB_RG_BATHROOMS_VALUES.length - 1
        : IB_RG_BATHROOMS_VALUES.indexOf(parseInt(max, 10));
  ...
  function getLivingSizeValues(min, max) {
    var r_min =
      null == min || "--" == min
        ? 0
        : IB_RG_LIVINGSIZE_VALUES.indexOf(parseInt(min, 10));
    var r_max =
      null == max || "--" == max
        ? IB_RG_LIVINGSIZE_VALUES.length - 1
        : IB_RG_LIVINGSIZE_VALUES.indexOf(parseInt(max, 10));
  ...
  function getLandSizeValues(min, max) {
    var r_min =
      null == min || "--" == min
        ? 0
        : IB_RG_LANDSIZE_VALUES.indexOf(parseInt(min, 10));
    var r_max =
      null == max || "--" == max
        ? IB_RG_LANDSIZE_VALUES.length - 1
        : IB_RG_LANDSIZE_VALUES.indexOf(parseInt(max, 10));
  ...
  if ("undefined" === typeof loadPropertyInModal) {
    function loadPropertyInModal(mlsNumber) {
      ...
      var viewListingDetailEndpoint = __flex_idx_search_filter.lookupListingsDetail.replace(
        /{{mlsNumber}}/g,
        mlsNumber
      );
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if ("undefined" !== typeof dataLayer) {
            if (
              __flex_g_settings.hasOwnProperty("has_dynamic_ads") &&
              "1" == __flex_g_settings.has_dynamic_ads
            ) {
              if (
                response.hasOwnProperty("mls_num") &&
          ...
          if (IB_MODAL_WRAPPER.length && IB_MODAL_TPL.length) {
            ...
            var rfn =
              typeof Cookies.get("_ib_user_firstname") !== "undefined"
                ? Cookies.get("_ib_user_firstname")
                : "";
            var rln =
              typeof Cookies.get("_ib_user_lastname") !== "undefined"
                ? Cookies.get("_ib_user_lastname")
                : "";
            var remail =
              typeof Cookies.get("_ib_user_email") !== "undefined"
                ? Cookies.get("_ib_user_email")
                : "";
            var rphone =
              typeof Cookies.get("_ib_user_phone") !== "undefined" &&
              Cookies.get("_ib_user_phone") != "null"
            ...
            if (parseInt(response.img_cnt, 10) > 0) {
              ...
              if (response.gallery.length) {
                IB_MODAL_SLIDER = IB_MODAL_SLIDER.greatSlider({
                  ...
                  onInited: function () {
                    IB_MODAL_WRAPPER.find(".gs-item-slider").on(
                      "click",
                      function () {
                  ...
                  onFullscreenIn: () => {
                    ...
                    if (!$ibmpTitle.length) {
                      IB_MODAL_WRAPPER.find(".gs-container-items").append(
                        '<span class="ib-pvsititle">' +
                          $(".ib-ptitle").text() +
                          " " +
                          $(".ib-pstitle").text() +
                          "</span>"
                    ...
                    const $ibmpNumbers = IB_MODAL_WRAPPER.find(
                      ".ib-pvsinumber"
                    );
                    if (!$ibmpNumbers.length) {
                      IB_MODAL_WRAPPER.find(".gs-container-items").append(
                        '<span class="ib-pvsinumber">' +
                          (IB_MODAL_WRAPPER.find(".gs-item-active").index() +
                            1) +
                          " of " +
                          IB_MODAL_WRAPPER.find(".ib-pvsitem").length +
                          "</span>"
                      );
                    } else {
                      IB_MODAL_WRAPPER.find(".ib-pvsinumber").text(
                        IB_MODAL_WRAPPER.find(".gs-item-active").index() +
                          1 +
                          " of " +
                          IB_MODAL_WRAPPER.find(".ib-pvsitem").length
                  ...
                  onStepEnd: ($itemActivo, indexIA) => {
                    if (
                      IB_MODAL_WRAPPER.find(".ib-pvslider:eq(0)").hasClass(
                        "gs-infs"
                      )
                    ) {
                      IB_MODAL_WRAPPER.find(".ib-pvsinumber").text(
            ...
            if (0 === parseInt(response.img_cnt, 10)) {
              ...
              var map = new google.maps.Map(
                IB_MODAL_WRAPPER.find(".ib-pmap")[0],
                {
            ...
            if ($("#ib-modal-property-map").length) {
              ...
              var map2 = new google.maps.Map(
                document.getElementById("ib-modal-property-map"),
                {
                  disableDoubleClickZoom: true,
                  scrollwheel: false,
                  streetViewControl: false,
            ...
            if ("share" in navigator) {
              ...
              document.title =
                ...
                response.mls_num +
                " " +
                response.address_short +
                " " +
                response.address_large;
              history.pushState(
                null,
                null,
                __flex_g_settings.propertyDetailPermalink + "/" + response.slug
              );
            } else {
              // for desktop
              var urlParams = new URLSearchParams(window.location.search);
            ...
            if (
              __flex_g_settings.hasOwnProperty("google_recaptcha_public_key") &&
              "" != __flex_g_settings.google_recaptcha_public_key
            ) {
              $(".ib-propery-inquiry-f:eq(0)")
                .find('input[name="recaptcha_response"]')
                .remove();
              grecaptcha
                .execute(__flex_g_settings.google_recaptcha_public_key)
                .then(function (token) {
                  $(".ib-propery-inquiry-f:eq(0)").append(
  ...
  function markPropertyAsFavorite(mlsNumber, element, from) {
    var markPropertyAsFavoriteEndpoint = __flex_idx_search_filter.trackListingsDetail.replace(
      /{{mlsNumber}}/g,
      mlsNumber
    );
  ...
  function buildMobileForm() {
    ...
    if (ib_min_beds.length) {
      ...
      ib_search_filter_frag.push(
        '<option value="--">' + word_translate.any + "</option>"
      );
    ...
    if (ib_min_baths.length) {
      ib_search_filter_dropdown = _.filter(
        ib_search_filter_params.baths_range,
        function (row) {
    ...
    if (ib_m_types.length) {
      ...
      for (var i = 0, l = ib_search_filter_dropdown.length; i < l; i++) {
        ...
        ib_search_filter_frag.push(
          '<li class="ib-item-wrap-fm ib-btn-chk-fm"><input class="ib-m-types-checkboxes" type="checkbox" value="' +
            option.value +
            '" id="s_types_' +
            option.value +
            '"><label for="s_types_' +
    ...
    if (ib_m_parking.length) {
      ...
      ib_search_filter_frag.push(
        '<li class="ib-item-wrap-fm ib-btn-chk-fm"><input class="ib-m-parking-checkboxes" name="ib_m_s_parking" type="radio" value="--" id="s_parking_any"><label for="s_parking_any">' +
          word_translate.any +
          "</label></li>"
      );
      ...
      for (var i = 0, l = ib_search_filter_dropdown.length; i < l; i++) {
        ...
        ib_search_filter_frag.push(
          '<li class="ib-item-wrap-fm ib-btn-chk-fm"><input name="ib_m_s_parking" type="radio" value="' +
            option.value +
            '" id="s_parking_' +
            option.value +
            '"><label for="s_parking_' +
            option.value +
            '">' +
            option.label +
            "</label></li>"
    ...
    if (ib_waterfront_switch.length) {
      ib_search_filter_dropdown = _.sortBy(
        ib_search_filter_params.waterfront_options,
        "name"
      );
      ib_search_filter_frag.push(
        '<option value="--">' + word_translate.any + "</option>"
    ...
    if (ib_m_features.length) {
      ib_search_filter_dropdown = _.sortBy(
        ib_search_filter_params.amenities,
        "name"
      );
      ...
      for (var i = 0, l = ib_search_filter_dropdown.length; i < l; i++) {
        ...
        if (
          "equestrian" == option.code &&
          __flex_idx_search_filter.boardId != "3"
        ) {
          continue;
        }
        ...
        else text_caracteristics = option.name;

        ib_search_filter_frag.push(
          '<li class="ib-item-wrap-fm ib-btn-chk-fm"><input class="ib-m-features-checkboxes" type="checkbox" value="' +
            option.code +
            '" id="s_amenity_' +
            option.code +
            '"><label for="s_amenity_' +
            option.code +
            '">' +
            text_caracteristics +
            "</label></li>"
  ...
  function attachListenersMobileForm() {
    ...
    ib_m_types.on("change", "input", function () {
      ...
      IB_SEARCH_FILTER_FORM.find('[name="property_type"]').val(
        fill_values.join(",")
      );
      IB_SEARCH_FILTER_FORM.find('[name="page"]').val(1);
      IB_SEARCH_FILTER_FORM.trigger("submit");
    ...
    ib_m_features.on("change", "input", function () {
      ...
      IB_SEARCH_FILTER_FORM.find('[name="amenities"]').val(
        fill_values.join(",")
      );
      IB_SEARCH_FILTER_FORM.find('[name="page"]').val(1);
      IB_SEARCH_FILTER_FORM.trigger("submit");
  ...
  function buildSearchFilterForm() {
    ...
    if (IB_LISTINGS_CT.length) {
      if (/webOS|iPhone|iPad/i.test(navigator.userAgent) === false) {
        ...
        IB_LISTINGS_CT.on("hover", ".ib-pitem", function (event) {
          ...
          setTimeout(function () {
            $(
              '.ib-infobox .ib-ibpitem[data-mls="' + itemScroll + '"]'
            ).addClass("ms-order-m");
          }, 100);
        });
      ...
      IB_LISTINGS_CT.on("click", ".btn_next_item, .btn_prev_item", function (
        event
      ) {
        ...
        $.ajax({
          ...
          beforeSend: function () {
            $("#collection-markert")
              .removeClass("gs-loaded")
              .addClass("gs-item-loading");
            $("#collection-markert .ib-item").fadeOut("fast");
          },
          success: function (response) {
            __flex_idx_search_filter.list_offmarket = response;
            if (
              __flex_idx_search_filter.list_offmarket.status != false &&
              __flex_idx_search_filter.list_offmarket.data != undefined
            ) {
              __flex_idx_search_filter.list_offmarket.data.forEach(function (
                item
              ) {
                $("#collection-markert")
                  .find(".ib-pifimg")
                ...
                $("#collection-markert")
                  .find(".ib-pifimg")
                  .attr("alt", item.address);
                jQuery("#collection-markert")
                  .find(".ib-title")
                  .text(item.address);
                $("#collection-markert")
                  .find(".idx_view_detail_market")
                  .attr(
                    "href",
                    "https://management.urbanresource.com/page-property/" +
                      item.property_id +
                      "/"
                  );
      ...
      IB_PAGINATION_CTRL.on("click", "a", function (event) {
        ...
        if (!$(this).hasClass("ib-plitem-active")) {
          ...
          if ($(window).width() < 1023) {
            $("html, body").animate(
              { scrollTop: $(".ib-wgrid").offset().top - 20 },
              1000
            );
          }
        }
    ...
    */
    ...
    if (IB_LB_WATERFRONT_OPTIONS.length) {
      for (
        var i = 0,
          l = __flex_idx_search_filter.search.waterfront_options.length;
        i < l;
        i++
      ) {
        ...
        if (
          __flex_idx_search_filter.search.waterfront_options[i].name ==
          "Bay Front"
        )
          text_label_trans = word_translate.bay_front;
        else if (
          __flex_idx_search_filter.search.waterfront_options[i].name == "Canal"
        )
        ...
        option.setAttribute(
          "value",
          __flex_idx_search_filter.search.waterfront_options[i].code
        );
      ...
      IB_LB_WATERFRONT_OPTIONS.on(
        "change",
        _.debounce(function () {
          var currentValue = "--" == this.value ? "" : this.value;
          IB_LB_WATERFRONT_OPTIONS.val(currentValue);

          IB_SEARCH_FILTER_FORM.find('[name="waterfront_options"]').val(
            currentValue
          );
          IB_SEARCH_FILTER_FORM.find('[name="page"]').val(1);
    ...
    if (IB_LB_PARKING_OPTIONS.length) {
      for (
        var i = 0, l = __flex_idx_search_filter.search.parking_options.length;
        i < l;
        i++
      ) {
        var option = document.createElement("option");
        option.innerHTML =
          __flex_idx_search_filter.search.parking_options[i].label;
        option.setAttribute(
          "value",
          __flex_idx_search_filter.search.parking_options[i].value
        );
        IB_DOCFRAG.appendChild(option);
      }
      ...
      IB_LB_PARKING_OPTIONS.on(
        "change",
        _.debounce(function () {
          var currentValue = "--" == this.value ? "" : this.value;
          IB_LB_PARKING_OPTIONS.val(currentValue);

          IB_SEARCH_FILTER_FORM.find('[name="parking_options"]').val(
            currentValue
          );
          IB_SEARCH_FILTER_FORM.find('[name="page"]').val(1);
    ...
    if (IB_LB_AMENITIES_OPTIONS.length) {
      IB_LB_AMENITIES_OPTIONS.each(function (index, node) {
        for (
          var i = 0, l = __flex_idx_search_filter.search.amenities.length;
          i < l;
          i++
        ) {
          if (
            -1 !==
            $.inArray(__flex_idx_search_filter.search.amenities[i].code, [
              "loft",
              "equestrian",
            ])
          ) {
          ...
          input.setAttribute(
            "id",
            "ib-amt-" + node.getAttribute("data-type") + "_" + i
          );
          input.setAttribute(
            "value",
            __flex_idx_search_filter.search.amenities[i].code
          );
          ...
          if (
            __flex_idx_search_filter.search.amenities[i].name == "Swimming Pool"
          )
            text_label_trans = word_translate.swimming_pool;
          else if (
            __flex_idx_search_filter.search.amenities[i].name == "Golf Course"
          )
            text_label_trans = word_translate.golf_course;
          else if (
            __flex_idx_search_filter.search.amenities[i].name == "Tennis Courts"
          )
            text_label_trans = word_translate.tennis_courts;
          else if (
            __flex_idx_search_filter.search.amenities[i].name ==
            "Gated Community"
          )
            ...
            __flex_idx_search_filter.search.amenities[i].name == "Penthouse"
          )
            text_label_trans = word_translate.penthouse;
          else if (
            __flex_idx_search_filter.search.amenities[i].name == "Waterfront"
          )
            ...
            __flex_idx_search_filter.search.amenities[i].name == "Furnished"
          )
            text_label_trans = word_translate.furnished;
          else if (
            __flex_idx_search_filter.search.amenities[i].name == "Equestrian"
          )
            text_label_trans = word_translate.equestrian;
          else if (
            __flex_idx_search_filter.search.amenities[i].name == "Short Sale"
          )
            text_label_trans = word_translate.short_sales;
          else if (
            __flex_idx_search_filter.search.amenities[i].name == "Foreclosure"
          )
            text_label_trans = word_translate.foreclosures;
          else if (
            __flex_idx_search_filter.search.amenities[i].name == "Boat Dock"
          )
            ...
            __flex_idx_search_filter.search.amenities[i].name == "Occupied"
          )
            text_label_trans = word_translate.occupied;
          else if (
            __flex_idx_search_filter.search.amenities[i].name == "Vacant"
          )
      ...
      IB_LB_AMENITIES_OPTIONS.on("change", "input", function () {
        ...
        IB_LB_AMENITIES_OPTIONS.find(
          'input[value="' + clickedOption + '"]'
        ).attr("checked", checkedOption);
    ...
    if (IB_LB_TYPES_OPTIONS.length) {
      ...
      IB_LB_TYPES_OPTIONS.each(function (index, node) {
        for (
          var i = 0, l = __flex_idx_search_filter.search.property_types.length;
          i < l;
          i++
        ) {
          var li = document.createElement("li");
          ...
          input.setAttribute(
            "id",
            "ib-ppt-" + node.getAttribute("data-type") + "_" + i
          );
          input.setAttribute(
            "value",
            __flex_idx_search_filter.search.property_types[i].value
          );
          input.classList.add("ib-icheck");
          var label = document.createElement("label");
          label.classList.add("ib-clabel");
          ...
          var text_label_trans = "";
          if (
            __flex_idx_search_filter.search.property_types[i].label == "Homes"
          ) {
            text_label_trans = word_translate.homes;
          } else if (
            __flex_idx_search_filter.search.property_types[i].label ==
            "Condominiums"
          ) {
      ...
      IB_LB_TYPES_OPTIONS.on("change", "input", function () {
        ...
        IB_LB_TYPES_OPTIONS.find('input[value="' + clickedOption + '"]').attr(
          "checked",
          checkedOption
        );
        ...
        if (
          lbl_ptypes.length &&
          lbl_ptypes.length < __flex_g_settings.params.property_types.length
        ) {
      ...
      IB_RG_PRICE_SALE.on("slide", function (event, ui) {
        ...
        if (
          ...
          if ("--" == max_lbl && !isNaN(min_lbl) && min_lbl > 0) {
            IB_LBL_PRICE_NTF.html(
              "$" +
                _.formatShortPrice(min_lbl) +
                " - " +
                word_translate.any_price
            );
          } else {
            IB_LBL_PRICE_NTF.html(
              "$" +
      ...
      IB_RG_BEDROOMS.on("slide", function (event, ui) {
        ...
        if (
          ...
          if (max_lbl > 5) {
            ...
            IB_LBL_BED_NTF.html(
              min_lbl + " - " + max_lbl + " " + word_translate.beds
            );
          }
        }
      });
      ...
      IB_RG_BATHROOMS.on("slide", function (event, ui) {
        ...
        if (
          ...
          if (max_lbl > 5) {
            ...
            IB_LBL_BATH_NTF.html(
              min_lbl + " - " + max_lbl + " " + word_translate.baths
            );
          }
        }
      });
  ...
  function saveFilterSearchForLead() {
    ...
    if ("no" === __flex_g_settings.anonymous) {
      $.ajax({
        type: "POST",
        url: __flex_idx_search_filter.saveListings.replace(
          /{{filterId}}/g,
          search_filter_ID
        ),
        data: {
      ...
      success: function (response) {
        if (typeof IS_SEARCH_FILTER_CARROUSEL !== "undefined") {
          ...
          for (var i = 0, l = response.items.length; i < l; i++) {
            ...
            html_response.push(
              '<li class="propertie" data-address="' +
                info_item.full_address +
                '"  data-id="' +
                info_item.mls_num +
                '" data-mls="' +
                info_item.mls_num +
            ...
            if (info_item.status == "5") {
              html_response.push(
                '<div class="flex-property-new-listing">' +
              ...
              html_response.push(
                '<div class="flex-property-new-listing">' +
                  word_translate.pending +
                  "!</div>"
              );
            } else if (
              info_item.hasOwnProperty("recently_listed") &&
              info_item.recently_listed === "yes"
            ) {
              html_response.push(
                '<div class="flex-property-new-listing">' +
                  word_translate.new_listing +
            ...
            html_response.push(
              '<h2 title="' +
                info_item.address_short +
                " " +
                info_item.address_large +
                '"><span>' +
                info_item.address_short +
                "</span></h2>"
            );
            ...
            html_response.push(
              '<li class="address">' + info_item.address_large + "</li>"
            );
            html_response.push(
              '<li class="price">$' + _.formatPrice(info_item.price) + "</li>"
            );
            ...
            html_response.push(
              '<li class="price-sf"><span>$' +
                info_item.price_sqft_m2 +
                " </span>/ " +
                word_translate.sqft +
                "<span>($244 m2)</span></li>"
            );
            ...
            if (0 == info_item.gallery.length) {
              html_response.push(
                '<li class="flex-slider-current"><img class="flex-lazy-image" data-original="https://www.idxboost.com/i/default_thumbnail.jpg"></li>'
              );
            } else {
              info_item.gallery.forEach(function (gallery, index_gallery) {
                if (index_gallery == 0) {
                  html_response.push(
                    '<li class="flex-slider-current"><img class="flex-lazy-image" data-original="' +
                      gallery +
                      '"></li>'
                  );
                } else {
                  html_response.push(
                    '<li class="flex-slider-item-hidden"><img class="flex-lazy-image" data-original="' +
                      gallery +
                      '"></li>'
                  );
                }
            ...
            if (info_item.status != "2") {
              if (info_item.is_favorite == 1) {
                html_response.push(
                  '<button class="clidxboost-btn-check"><span class="flex-favorite-btn clidxboost-icon-check clidxboost-icon-check-list active" data-alert-token="' +
                    info_item.token_alert +
                    '"></span></button>'
                );
              } else {
                html_response.push(
          ...
          if (html_response.length) {
            $("#search-filter-slider-" + response.params.token_id).html(
              html_response.join("")
            );
                ...
                myLazyLoad = new LazyLoad({
                  ...
                  callback_error: function (element) {
                    $(element)
                      .attr(
                        "src",
                        "https://idxboost.com/i/default_thumbnail.jpg"
                      )
                      .removeClass("error")
                      .addClass("loaded");
                    $(element).attr(
            ...
            $("#search-filter-slider-" + response.params.token_id).addClass(
            ...
            myLazyLoad = new LazyLoad({
              ...
              callback_error: function (element) {
                $(element)
                  .attr("src", "https://idxboost.com/i/default_thumbnail.jpg")
                  .removeClass("error")
                  .addClass("loaded");
                $(element).attr(
                  "data-origin",
        ...
        __flex_idx_search_filter.list_offmarket =
          response.list_off_market_listing;
            ...
            if ("undefined" !== typeof dataLayer) {
              if (response.hasOwnProperty("items") && response.items.length) {
                if (
                  ...
                  response.events.hasOwnProperty("view_search_results")
                ) {
                  dataLayer.push({
                    ...
                    preferred_baths_range:
                      response.events.view_search_results.preferred_baths_range,
                    preferred_beds_range:
                      response.events.view_search_results.preferred_beds_range,
                    preferred_price_range:
                      response.events.view_search_results.preferred_price_range,
                    property_type:
                      response.events.view_search_results.property_type,
                  });
                }
              }
            }
        ...
        if ("0" == params.sale_type) {
          if (null == params.min_sale_price && null == params.max_sale_price) {
            ...
            null != params.min_sale_price &&
            null == params.max_sale_price
          ) {
            if (0 == params.min_sale_price) {
              ...
              IB_LBL_PRICE_NTF.html(
                "$" +
                  _.formatShortPrice(params.min_sale_price) +
                  " - " +
                  word_translate.any_price
              );
            }
            ...
            IB_LBL_PRICE_NTF.html(
              "$" +
                _.formatShortPrice(params.min_sale_price) +
                " - $" +
                _.formatShortPrice(params.max_sale_price)
            );
          }
        } else {
          if (null == params.min_rent_price && null == params.max_rent_price) {
            ...
            null != params.min_rent_price &&
            null == params.max_rent_price
          ) {
            if (0 == params.min_rent_price) {
              ...
              IB_LBL_PRICE_NTF.html(
                "$" +
                  _.formatShortPrice(params.min_rent_price) +
                  " - " +
                  word_translate.any_price
              );
            }
            ...
            IB_LBL_PRICE_NTF.html(
              "$" +
                _.formatShortPrice(params.min_rent_price) +
                " - $" +
                _.formatShortPrice(params.max_rent_price)
            );
          }
        }
        ...
        if (null == params.min_beds && null == params.max_beds) {
          ...
          if (0 == params.min_beds) {
            ...
            IB_LBL_BED_NTF.html(
              _.formatShortPrice(params.min_beds) +
                " - " +
                word_translate.any_beds
            );
          }
        } else {
          IB_LBL_BED_NTF.html(
            _.formatShortPrice(params.min_beds) +
              " - " +
              _.formatShortPrice(params.max_beds) +
              " " +
              word_translate.beds
          );
        }
        ...
        if (null == params.min_baths && null == params.max_baths) {
          ...
          if (0 == params.min_baths) {
            ...
            IB_LBL_BATH_NTF.html(
              _.formatShortPrice(params.min_baths) +
                " - " +
                word_translate.any_baths
            );
          }
        } else {
          IB_LBL_BATH_NTF.html(
            _.formatShortPrice(params.min_baths) +
              " - " +
              _.formatShortPrice(params.max_baths) +
              " " +
              word_translate.baths
          );
        }
        ...
        if (
          -1 != $.inArray("2", params.property_type) ||
          -1 != $.inArray(2, params.property_type)
        ) {
        ...
        if (
          -1 != $.inArray("1", params.property_type) ||
          -1 != $.inArray(1, params.property_type)
        ) {
        ...
        if (labelPropertyTypes.length) {
          ...
          if (
            labelPropertyTypes.length ===
            __flex_idx_search_filter.search.property_types.length
          ) {
            IB_LBL_TYPES_NTF.html(word_translate.any_type);
          } else {
        ...
        IB_RG_MATCHING.html(
          word_translate.view +
            " " +
            _.formatShortPrice(pagination.count) +
            " " +
            word_translate.listings
        );
        $(".ib-fmapply").html(
          word_translate.view +
            " " +
        ...
        IB_SEARCH_FILTER_FORM.find('[name="filter_search_keyword_label"]').val(
          params.filter_search_keyword_label
        );
        IB_SEARCH_FILTER_FORM.find('[name="filter_search_keyword_type"]').val(
          params.filter_search_keyword_type
        );
        IB_SEARCH_FILTER_FORM.find('[name="waterfront_options"]').val(
          params.waterfront_options
        );
        IB_SEARCH_FILTER_FORM.find('[name="min_sale_price"]').val(
          params.min_sale_price
        );
        IB_SEARCH_FILTER_FORM.find('[name="max_sale_price"]').val(
          params.max_sale_price
        );
        IB_SEARCH_FILTER_FORM.find('[name="min_rent_price"]').val(
          params.min_rent_price
        );
        IB_SEARCH_FILTER_FORM.find('[name="max_rent_price"]').val(
          params.max_rent_price
        );
        ...
        IB_SEARCH_FILTER_FORM.find('[name="min_living_size"]').val(
          params.min_living_size
        );
        IB_SEARCH_FILTER_FORM.find('[name="max_living_size"]').val(
          params.max_living_size
        );
        IB_SEARCH_FILTER_FORM.find('[name="min_lot_size"]').val(
          params.min_lot_size
        );
        IB_SEARCH_FILTER_FORM.find('[name="max_lot_size"]').val(
          params.max_lot_size
        );
        ...
        if (
          params.hasOwnProperty("filter_search_keyword_label") &&
          params.hasOwnProperty("polygon_search")
        ) {
          if (
            null == params.filter_search_keyword_label &&
            null == params.polygon_search &&
            !params.hasOwnProperty("kml_boundaries")
          ) {
            IB_LOOKUP_DRAG = true;
          }
        ...
        if (
          ("" == params.polygon_search || null == params.polygon_search) &&
          ("" == params.filter_search_keyword_label ||
            null == params.filter_search_keyword_label)
        ) {
          IB_LOOKUP_DRAG = true;
        ...
        if (IB_PAGINATION_CTRL.length) {
          if (pagination.pages > 1) {
            ...
            if (params.currentpage > 1) {
              htmlBuildPagination.push(
                '<a class="ib-pagfirst ib-paggo" data-page="1" href="#"><span>' +
                  word_translate.first_page +
                  "</span></a>"
              );
            }
            ...
            if (pagination.prev) {
              htmlBuildPagination.push(
                '<a class="ib-pagprev ib-paggo" data-page="' +
                  (params.currentpage - 1) +
                  '" href="#"><span>' +
                  word_translate.previous_page +
                  "</span></a>"
              );
            }
            ...
            if (pagination.range.length) {
              ...
              for (var i = 0, l = pagination.range.length; i < l; i++) {
                if (params.currentpage == pagination.range[i]) {
                  htmlBuildPagination.push(
                    '<a class="ib-plitem ib-plitem-active" data-page="' +
                      pagination.range[i] +
                      '" href="#">' +
                      pagination.range[i] +
                      "</a>"
            ...
            if (pagination.next) {
              htmlBuildPagination.push(
                '<a class="ib-pagnext ib-paggo" data-page="' +
                  (params.currentpage + 1) +
                  '" href="#"><span>' +
                  word_translate.next_page +
                  "</span></a>"
              );
            }
            ...
            if (params.currentpage < pagination.pages) {
              htmlBuildPagination.push(
                '<a class="ib-paglast ib-paggo" data-page="' +
                  pagination.pages +
                  '" href="#"><span>' +
                  word_translate.last_page +
                  "</span></a>"
              );
            }
        ...
        if (IB_HEADING_CT.length) {
          IB_HEADING_CT.html(
            word_translate.showing +
              ...
              word_translate.of +
              " " +
              _.formatPrice(pagination.count) +
              " " +
              word_translate.properties +
              "."
          );
        ...
        if (IB_LB_TYPES_OPTIONS.length) {
          ...
          IB_LB_TYPES_OPTIONS.find("input").each(function (index, node) {
            ...
            var currentValue =
              false === isNaN(node.value) ? node.value + "" : node.value;
        ...
        if (IB_LB_WATERFRONT_OPTIONS.length) {
          IB_LB_WATERFRONT_OPTIONS.val(
            null == params.waterfront_options ? "--" : params.waterfront_options
          );
        }

        if (IB_LB_PARKING_OPTIONS.length) {
          IB_LB_PARKING_OPTIONS.val(
            null == params.parking_options ? "--" : params.parking_options
          );
        }
        ...
        if (IB_RG_PRICE_SALE_LBL_RT.length) {
          var max_sale_price =
            null == params.max_sale_price
              ? word_translate.any_price
              : "$" + _.formatPrice(params.max_sale_price);
        ...
        if (IB_RG_PRICE_RENT_LBL_RT.length) {
          var max_rent_price =
            null == params.max_rent_price
              ? word_translate.any_price
              : "$" + _.formatPrice(params.max_rent_price);
        ...
        if (IB_RG_LIVING_LBL_LT.length) {
          var min_living_size =
            _.formatPrice(params.min_living_size) + " " + word_translate.sqft;
          IB_RG_LIVING_LBL_LT.val(min_living_size);
        }

        if (IB_RG_LIVING_LBL_RT.length) {
          var max_living_size =
            null == params.max_living_size
              ? word_translate.any_size
              : _.formatPrice(params.max_living_size) +
                " " +
                word_translate.sqft;
        ...
        if (IB_RG_LAND_LBL_LT.length) {
          var min_lot_size =
            _.formatPrice(params.min_lot_size) + " " + word_translate.sqft;
          IB_RG_LAND_LBL_LT.val(min_lot_size);
        }

        if (IB_RG_LAND_LBL_RT.length) {
          var max_lot_size =
            null == params.max_lot_size
              ? word_translate.any_size
              : _.formatPrice(params.max_lot_size) + " " + word_translate.sqft;
        ...
        IB_RG_PRICE_SALE.slider(
          "option",
          "values",
          getPriceSaleValues(params.min_sale_price, params.max_sale_price)
        );
        ...
        IB_RG_PRICE_RENT.slider(
          "option",
          "values",
          getPriceRentValues(params.min_rent_price, params.max_rent_price)
        );
        ...
        IB_RG_YEARBUILT.slider(
          "option",
          "values",
          getYearValues(params.min_year, params.max_year)
        );
        ...
        IB_RG_BEDROOMS.slider(
          "option",
          "values",
          getBedroomValues(params.min_beds, params.max_beds)
        );
        ...
        IB_RG_BATHROOMS.slider(
          "option",
          "values",
          getBathroomValues(params.min_baths, params.max_baths)
        );
        ...
        IB_RG_LIVINGSIZE.slider(
          "option",
          "values",
          getLivingSizeValues(params.min_living_size, params.max_living_size)
        );
        ...
        IB_RG_LANDSIZE.slider(
          "option",
          "values",
          getLandSizeValues(params.min_lot_size, params.max_lot_size)
        );
        ...
        if (typeof event !== "undefined") {
          if ("" != slug) {
            ...
            history.pushState(
              null,
              null,
              __flex_idx_search_filter.searchFilterPermalink
            );
            initial_title = document.title;
        ...
        if ("undefined" === typeof IB_MAP) {
          ...
          var gmap_bounds = new google.maps.LatLngBounds(
            new google.maps.LatLng(
              parseFloat(gmap_coords[0]),
              parseFloat(gmap_coords[1])
            ), // SW
            new google.maps.LatLng(
              parseFloat(gmap_coords[2]),
              parseFloat(gmap_coords[3])
            ) // NE
          );

          IB_MAP = new google.maps.Map(
            document.getElementById("flex_idx_search_filter_map"),
            {
              center: {
                lat: gmap_bounds.getCenter().lat(),
                lng: gmap_bounds.getCenter().lng(),
              },
        ...
        for (i = 0; i < unique_properties.length; i++) {
          ...
          IB_MARKER = new RichMarker({
            position: new google.maps.LatLng(
              parseFloat(property.item.lat),
              parseFloat(property.item.lng)
            ),
            map: IB_MAP,
            flat: true,
            content:
              property.group.length > 1
                ? '<div class="dgt-richmarker-group"><strong>' +
                  property.group.length +
                  "</strong><span>" +
                  word_translate.units +
                  "</span></div>"
                : '<div class="dgt-richmarker-single"><strong>$' +
          ...
          google.maps.event.addListener(
            IB_MARKER,
            "click",
            handleMarkerClick(IB_MARKER, property, IB_MAP)
          );

          google.maps.event.addListener(
            IB_MARKER,
            "mouseover",
            handleMarkerMouseOver(IB_MARKER)
          );
          google.maps.event.addListener(
            IB_MARKER,
            "mouseout",
            handleMarkerMouseOut(IB_MARKER)
          );
        }
        ...
        if (items.length === 0) {
          $(".ib-heading-ct").html(
            word_translate.showing + " 0 " + word_translate.properties + "."
          );
  ...
  $(function () {
    $(document).on("click", ".ib-removeb-tg", function () {
      ...
      if (window.innerWidth < 990) {
        ...
        setTimeout(function () {
          ...
          IB_SEARCH_FILTER_FORM.find(
            '[name="filter_search_keyword_label"]'
          ).val("");
          IB_SEARCH_FILTER_FORM.find('[name="filter_search_keyword_type"]').val(
            ""
          );
    ...
    $(document).on("click", "#clidxboost-data-loadMore-niche", function (
      ...
      size_li_actives_X =
        size_li_actives_X + 8 <= size_li ? size_li_actives_X + 8 : size_li;
      $(
        ".clidxboost-body-niche .clidxboost-td-niche:lt(" +
          size_li_actives_X +
          ")"
      ).slideDown();
      $(
        ".clidxboost-body-niche .clidxboost-td-niche:lt(" +
          size_li_actives_X +
          ")"
      ).addClass("clidxboost-td-niche-show");
      if (size_li_actives_X == size_li) {
        $("#clidxboost-container-loadMore-niche").hide();
      }
      size_li_actives = $(".clidxboost-body-niche .clidxboost-td-niche-show")
        .length;
      var result_item = parseInt(size_li) - parseInt(size_li_actives);
      $(".clidxboost-count-niche").text(
        result_item + " " + word_translate.more_schools
      );
    });

    $(document).on(
      "click",
      ".clidxboost-niche-tab-filters button",
      function () {
        event.stopPropagation();
        ...
        if ($(this).attr("data-filter") == "all") {
          ...
          $(".clidxboost-td-niche.elementary").addClass(
            "clidxboost-td-niche-show"
          );
          $("#clidxboost-container-loadMore-niche").hide();
    ...
    */
    ...
    $(".idx-bta-map").click(function () {
      ...
      $ibMapGridContainer
        .removeClass("ib-vgrid-active")
        .addClass("ib-vmap-active");
    ...
    $(".idx-bta-grid").click(function () {
      ...
      $ibMapGridContainer
        .addClass("ib-vgrid-active")
        .removeClass("ib-vmap-active");
    });
    ...
    if (IB_MODAL_WRAPPER.length) {
        ...
        if ("share" in navigator) {
          ...
          if ("" === urlParams.toString()) {
            history.pushState(
              null,
              null,
              __flex_idx_search_filter_v2.searchFilterPermalink
            );
          } else {
            history.pushState(null, null, "?" + urlParams.toString());
          }
      ...
      IB_SAVE_SEARCH_MODALS.on("submit", function (event) {
        ...
        var search_condition = encodeURIComponent(
          IB_SEARCH_FILTER.attr("data-condition")
        );
        var search_filter_params = IB_SEARCH_FILTER.attr("data-params");
        var search_filter_ID = IB_SEARCH_FILTER.data("filter-id");
      ...
      IB_SAVE_SEARCH_MODALS.find(".ib-mgsubmit").click(function () {
        IB_SAVE_SEARCH_MODALS.submit();
      });
      ...
      $(".ib-property-share-friend-f").on("submit", function (event) {
        ...
        var shareWithFriendEndpoint = __flex_idx_search_filter.shareWithFriendEndpoint.replace(
          /{{mlsNumber}}/g,
          mlsNumber
        );
      ...
      IB_MODAL_WRAPPER.on("submit", ".ib-propery-inquiry-f", function (event) {
        ...
        var mlsNumber = $(this).find("input[name='mls_number']:eq(0)").val();
        var requestInformationEndpoint = __flex_idx_search_filter.requestInformationEndpoint.replace(
          /{{mlsNumber}}/g,
          mlsNumber
        );
        ...
        $("#ib-email-thankyou").addClass("ib-md-active");
        $(document).on("click", "#ib-email-thankyou .ib-mmclose", function (
          event
        ) {
          event.preventDefault();
      ...
      IB_MODAL_WRAPPER.on("click", ".ib-pvitem", function (event) {
        ...
        $(this)
          ...
          .parent()
          .parent()
          .removeClass("ib-pva-photos ib-pva-map")
          .addClass("ib-pva-" + tabToOpen);
  ...
  if ($filterMobile.length) {
    $filterMobile.on("click", ".ib-fititle", function () {
      ...
      if ($fItem.hasClass("ib-fitem-active")) {
        ...
        $fItem
          .addClass("ib-fitem-active")
          .siblings()
          .removeClass("ib-fitem-active");
      }
    });
  }
    ...
    $ibAdvanced.on("click", function () {
      if (window.innerWidth < 990) {
        ...
        if (Object.keys(ib_moreFilter).length <= 0) {
          ...
          $(flex_filter_form)
            .find("input:radio, input:checkbox, select")
            .each(function () {
              var ID = $(this).attr("id");
              var valor = $(this).val();
              if (
    ...
    $("#ib-apply-clear").on("click", function () {
      if (
        ...
        $.each(moreFilterHidden, function (name, value) {
          if (
            (name == "min_rent_price" || name == "max_rent_price") &&
            parseInt(value) > 0
          ) {
            $(".ib-item-collapse-sale").hide();
            $(".ib-item-collapse-rent").show();
        ...
        $(flex_filter_form)
          ...
          .each(function () {
            ...
            if ($.inArray($(this).attr("type"), ["checkbox", "radio"]) !== -1) {
              $(this).prop(
                "checked",
                ib_moreFilter[ID] != undefined ? true : false
              );
            } else {
              if (ib_moreFilter[ID] != undefined) {
                $(this)
                  .attr("value", ib_moreFilter[ID])
  ...
  if ($btnOpeners.length) {
    $btnOpeners.find(".ib-oiwrapper").on("click", function () {
      ...
      if ($parent.hasClass("ib-oitem-active")) {
        ...
        $parent
          .addClass("ib-oitem-active")
          .siblings()
          .removeClass("ib-oitem-active");
        if (!$parent.hasClass("ib-oadbanced"))
          $filterMobile.removeClass("ib-fmobile-active");
      }
    });
  }
  ...
  $(window).scroll(function () {
    ...
    if ($currentScroll > lastScroll) {
      if ($currentScroll >= $ibFilterContainer.position().top) {
        if (!$ibFilterContainer.hasClass("ib-filter-container-inscroll"))
          $ibFilterContainer.addClass("ib-filter-container-inscroll");
      }
    } else {
      if ($currentScroll <= $ibFilterContainer.position().top) {
        if ($ibFilterContainer.hasClass("ib-filter-container-inscroll"))
          $ibFilterContainer.removeClass("ib-filter-container-inscroll");
      }
    }
...
if (typeof IS_SEARCH_FILTER_CARROUSEL !== "undefined") {
  (function ($) {
    $(function () {
      ...
      $(".ib-properties-slider").on("click", ".flex-slider-next", function (
        event
      ) {
        event.stopPropagation();
        ...
        $(this)
          ...
          .find("li")
          .eq(index)
          .removeClass("flex-slider-item-hidden")
          .addClass("flex-slider-current");
        myLazyLoad.update();
      ...
      $(".ib-properties-slider").on("click", ".flex-favorite-btn", function (
        event
      ) {
        event.stopPropagation();
        event.preventDefault();
