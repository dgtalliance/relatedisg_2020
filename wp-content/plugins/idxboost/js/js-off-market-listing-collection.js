                    ...
                    for (var i = 0, l = items.length; i < l; i++) {
                        ...
                        */
                        ...
                        for (var k = 0, m = item.gallery.length; k < m; k++) {
                            // listingHTML.push('<li><img src="' + item.gallery[k] + '" data-src="' + item.gallery[k] + '" alt="' + item.address + '"></li>');
                            if (k <= 0) {
                                listingHTML.push('<li class="flex-slider-current"><img class="flex-lazy-image" data-original="' + item.gallery[k] + '" alt="' + item.address + '"></li>');
                            } else {
                                listingHTML.push('<li class="flex-slider-item-hidden"><img class="flex-lazy-image" data-original="' + item.gallery[k] + '" alt="' + item.address + '"></li>');
                            }
                        }
                        listingHTML.push('</ul>');
