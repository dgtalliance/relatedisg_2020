...
//delete feature hopa
if (
  [1, 2, 3].includes(parseFloat(__flex_idx_search_filter_v2.boardId)) === false
) {
  var item_dele = __flex_idx_search_filter_v2.search.amenities
    .map(function (item) {
      return item.code;
    })
    .indexOf("hopa");
...
(function ($) {
  ...
  Handlebars.registerHelper("capturePositionHackbox", function (index) {
    if (1 === index && __flex_idx_search_filter_v2.hackbox.status === true) {
      return (
        ...
        __flex_idx_search_filter_v2.hackbox.content +
        "</li>"
      );
    } else {
      return "";
  ...
  Handlebars.registerHelper("idxFavoriteClass", function (property) {
    ...
    if (null == __flex_idx_search_filter_v2.search.view_icon_type) {
      var currentClass = options[0];
    } else {
  ...
  Handlebars.registerHelper("idxPermalinkModal", function (slug) {
    if (typeof IB_AGENT_REGISTRATION_KEY !== "undefined") {
      return (
        IB_AGENT_PROPERTY_SLUG +
        "/" +
        slug +
        "?ibref=" +
        encodeURIComponent(IB_AGENT_REGISTRATION_KEY)
      );
      // return (
  ...
  Handlebars.registerHelper("idxSliderLoop", function (property) {
    ...
    if (property.hasOwnProperty("gallery") && property.gallery.length) {
      for (var i = 0, l = property.gallery.length; i < l; i++) {
        images.push(
  ...
  Handlebars.registerHelper("propertyPermalinkOpen", function (slug) {
    if (typeof IB_AGENT_REGISTRATION_KEY !== "undefined") {
      // console.log(IB_AGENT_PROPERTY_SLUG);
      return (
        IB_AGENT_PROPERTY_SLUG +
        "/" +
        slug +
  ...
  Handlebars.registerHelper("agentPhoto", function (property) {
    if ("undefined" !== typeof IB_AGENT_PHOTO_SRC) {
      return IB_AGENT_PHOTO_SRC;
    }
  ...
  Handlebars.registerHelper("agentFullName", function (property) {
    if ("undefined" !== typeof IB_AGENT_FULL_NAME) {
  ...
  Handlebars.registerHelper("agentPhone", function (property) {
    if ("undefined" !== typeof IB_AGENT_PHONE_NUMBER) {
  ...
  __flex_idx_search_filter_v2.search.price_sale_range.push({
    label: word_translate.any_price,
    value: "--",
  });
  __flex_idx_search_filter_v2.search.price_rent_range.push({
    label: word_translate.any_price,
    value: "--",
  });

  __flex_idx_search_filter_v2.search.living_size_range.push({
    label: word_translate.any_size,
    value: "--",
  });
  __flex_idx_search_filter_v2.search.lot_size_range.push({
    label: word_translate.any_size,
    value: "--",
  });
  ...
  var IB_RG_PRICE_SALE_VALUES = _.pluck(
    __flex_idx_search_filter_v2.search.price_sale_range,
    "value"
  );
  var IB_RG_PRICE_RENT_VALUES = _.pluck(
    __flex_idx_search_filter_v2.search.price_rent_range,
    "value"
  );
  var IB_RG_BEDROOMS_VALUES = _.pluck(
    __flex_idx_search_filter_v2.search.beds_range,
    "value"
  );
  var IB_RG_BATHROOMS_VALUES = [0, 1, 2, 3, 4, 5, 6];
  var IB_RG_LIVINGSIZE_VALUES = _.pluck(
    __flex_idx_search_filter_v2.search.living_size_range,
    "value"
  );
  var IB_RG_LANDSIZE_VALUES = _.pluck(
    __flex_idx_search_filter_v2.search.lot_size_range,
    "value"
  );
  var IB_RG_YEARBUILT_VALUES = _.pluck(
    __flex_idx_search_filter_v2.search.year_built_range,
    "value"
  );
    ...
    return function () {
      ...
      if (property.group.length > 1) {
        ...
        for (var i = 0, l = property.group.length; i < l; i++) {
          ...
          infobox_content.push(
            '<li class="ib-ibpitem" data-mls="' +
              property_group.mls_num +
              '" data-status="' +
              property_group.status +
              '">'
          );
          ...
          if ("undefined" !== typeof IB_AGENT_REGISTRATION_KEY) {
            infobox_content.push(
              '<a href="' +
                __flex_idx_search_filter_v2.propertyDetailPermalink +
                "/" +
  ...
  if ("undefined" === typeof loadPropertyInModal) {
    function loadPropertyInModal(mlsNumber) {
      ...
      var viewListingDetailEndpoint = __flex_idx_search_filter_v2.lookupListingsDetail.replace(
        /{{mlsNumber}}/g,
        mlsNumber
      );
      ...
      $.ajax({
        ...
        data: {
          ...
          ibref:
            typeof IB_AGENT_REGISTRATION_KEY !== "undefined"
              ? IB_AGENT_REGISTRATION_KEY
              : null,
        },
  ...
  function markPropertyAsFavorite(mlsNumber, element, from) {
    var markPropertyAsFavoriteEndpoint = __flex_idx_search_filter_v2.trackListingsDetail.replace(
      /{{mlsNumber}}/g,
      mlsNumber
    );
    ...
    if (ib_m_features.length) {
      ...
      for (var i = 0, l = ib_search_filter_dropdown.length; i < l; i++) {
        ...
        if (
          ...
          __flex_idx_search_filter_v2.boardId != "3"
        ) {
          continue;
        }
        ...
        if (
          "loft" == option.code &&
          __flex_idx_search_filter_v2.boardId != "5"
        ) {
          continue;
        }
  ...
  function buildSearchFilterForm() {
    ...
    if (IB_LB_WATERFRONT_OPTIONS.length) {
      for (
        var i = 0,
          l = __flex_idx_search_filter_v2.search.waterfront_options.length;
        i < l;
        i++
      ) {
        ...
        if (
          __flex_idx_search_filter_v2.search.waterfront_options[i].name ==
          "Bay Front"
        )
        ...
        option.setAttribute(
          "value",
          __flex_idx_search_filter_v2.search.waterfront_options[i].code
        );
    ...
    if (IB_LB_PARKING_OPTIONS.length) {
      for (
        var i = 0,
          l = __flex_idx_search_filter_v2.search.parking_options.length;
        i < l;
        i++
      ) {
        var option = document.createElement("option");
        option.innerHTML =
          __flex_idx_search_filter_v2.search.parking_options[i].label;
        option.setAttribute(
          "value",
          __flex_idx_search_filter_v2.search.parking_options[i].value
        );
        IB_DOCFRAG.appendChild(option);
      }
    ...
    if (IB_LB_AMENITIES_OPTIONS.length) {
      IB_LB_AMENITIES_OPTIONS.each(function (index, node) {
        for (
          var i = 0, l = __flex_idx_search_filter_v2.search.amenities.length;
          i < l;
          i++
        ) {
          if (
            -1 !==
            $.inArray(__flex_idx_search_filter_v2.search.amenities[i].code, [
              "loft",
              "equestrian",
            ])
          ) {
          ...
          input.setAttribute(
            "value",
            __flex_idx_search_filter_v2.search.amenities[i].code
          );
          ...
          var text_label_trans = "";
          if (
            __flex_idx_search_filter_v2.search.amenities[i].name ==
            "Swimming Pool"
          )
            ...
            __flex_idx_search_filter_v2.search.amenities[i].name == "Lofts"
          )
            text_label_trans = word_translate.lofts;
          else if (
            __flex_idx_search_filter_v2.search.amenities[i].name == "Penthouse"
          )
            text_label_trans = word_translate.penthouse;
          else if (
            __flex_idx_search_filter_v2.search.amenities[i].name == "Waterfront"
          )
            text_label_trans = word_translate.water_front;
          else if (
            __flex_idx_search_filter_v2.search.amenities[i].name == "Pets"
          )
            text_label_trans = word_translate.pets;
          else if (
            __flex_idx_search_filter_v2.search.amenities[i].name == "Furnished"
          )
            text_label_trans = word_translate.furnished;
          else if (
            __flex_idx_search_filter_v2.search.amenities[i].name == "Equestrian"
          )
            text_label_trans = word_translate.equestrian;
          else if (
            __flex_idx_search_filter_v2.search.amenities[i].name == "Short Sale"
          )
            ...
            __flex_idx_search_filter_v2.search.amenities[i].name == "Boat Dock"
          )
            ...
            __flex_idx_search_filter_v2.search.amenities[i].name == "Occupied"
          )
            text_label_trans = word_translate.occupied;
          else if (
            __flex_idx_search_filter_v2.search.amenities[i].name == "Vacant"
          )
    ...
    if (IB_LB_TYPES_OPTIONS.length) {
      IB_LB_TYPES_OPTIONS.each(function (index, node) {
        for (
          var i = 0,
            l = __flex_idx_search_filter_v2.search.property_types.length;
          i < l;
          i++
        ) {
          var li = document.createElement("li");
          ...
          input.setAttribute(
            "value",
            __flex_idx_search_filter_v2.search.property_types[i].value
          );
          input.classList.add("ib-icheck");
          var label = document.createElement("label");
          label.classList.add("ib-clabel");
          ...
          var text_label_trans = "";
          if (
            __flex_idx_search_filter_v2.search.property_types[i].label ==
            "Homes"
          ) {
            ...
            "Dock" == __flex_idx_search_filter_v2.search.property_types[i].label
          ) {
  ...
  function saveFilterSearchForLead() {
    ...
    if (
      "no" === __flex_g_settings.anonymous &&
      typeof search_filter_ID !== "undefined"
    ) {
      $.ajax({
        type: "POST",
        url: __flex_idx_search_filter_v2.saveListings.replace(
          /{{filterId}}/g,
          search_filter_ID
        ),
        data: {
      ...
      success: function (response) {
        ...
        if (labelPropertyTypes.length) {
          ...
          if (
            ...
            __flex_idx_search_filter_v2.search.property_types.length
          ) {
            IB_LBL_TYPES_NTF.html(word_translate.any_type);
          } else {
          ...
          $(document).on("click", ".ib-removeb-tg", function () {
            ...
            if (window.innerWidth < 990) {
              ...
              setTimeout(function () {
                ...
                IB_SEARCH_FILTER_FORM.find(
                  '[name="filter_search_keyword_type"]'
                ).val("");
                IB_SEARCH_FILTER_FORM.find('[name="polygon_search"]').val("");
                IB_SEARCH_FILTER_FORM.find('[name="page"]').val(1);
  ...
  $(function () {
    ...
    if (IB_MODAL_WRAPPER.length) {
      ...
      $(".ib-property-share-friend-f").on("submit", function (event) {
        ...
        var shareWithFriendEndpoint = __flex_idx_search_filter_v2.shareWithFriendEndpoint.replace(
          /{{mlsNumber}}/g,
          mlsNumber
        );
      ...
      IB_MODAL_WRAPPER.on("submit", ".ib-propery-inquiry-f", function (event) {
        ...
        var mlsNumber = $(this).find("input[name='mls_number']:eq(0)").val();
        var requestInformationEndpoint = __flex_idx_search_filter_v2.requestInformationEndpoint.replace(
          /{{mlsNumber}}/g,
          mlsNumber
        );
